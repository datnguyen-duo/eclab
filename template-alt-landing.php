<?php
/* Template Name: Alternate Landing */
get_header('alt');
...
font-weight:bold;
    ...
    .lined_after_title:after, #can_embed_form_inner>h2+h4:after, #can_embed_form_inner>.last_line+h4:after, #can_embed_form .action_sidebar>h4:not(.sidebartitle):after, #can_embed_form #select_tickets>h4:after, #can_embed_form #letter-form>div>h4:after, #can_embed_form #letter-form #form_col1>h4:after, #can_embed_form #letter-form #form_col2>h4:after, #can_embed_form h3+h4:after, .event_campaign #can_embed_form>h2+h4:after, .letter #can_embed_form h2.line+h4:after {
content: "";
width: 40%;
...
.landing_page_wrap .first_section_landing .first_section_landing_content .right span.third {
font-size: 52px;
left: 70px;
top: 43%;
...
.landing_page_wrap .first_section_landing .first_section_landing_content .right p {
font-size: 24px;
text-align: center;
position: absolute;
font-family: "korolev";
...
#can_embed_form form li:nth-child(2) {
width: 100%!important;
...
*/
.lined_after_title, #can_embed_form_inner>h2+h4, #can_embed_form_inner>.last_line+h4, #can_embed_form .action_sidebar>h4:not(.sidebartitle), #can_embed_form #select_tickets>h4, #can_embed_form #letter-form>div>h4, #can_embed_form #letter-form #form_col1>h4, #can_embed_form #letter-form #form_col2>h4, #can_embed_form h3+h4, .event_campaign #can_embed_form>h2+h4, .letter #can_embed_form h2.line+h4 {
text-align: center;
...
.landing_page_wrap .first_section_landing .first_section_landing_content {
    ...
    <div class="first_section_landing">
        <div class="first_section_landing_content content_holder">
            <div class="left">
                ...
                <?php if($hero_section['form_embed_code']): ?>
                    
                        <?php echo $hero_section['form_embed_code']; ?>
    ...
    <div class="second_section_landing">
        ...
        <div class="second_section_landing_content content_holder">
            ...
            <div class="all_stories">
                ...
                <? if($stories_section['stories_section_button']) { ?>
