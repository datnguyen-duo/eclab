(function ($) {
  $(document).ready(function () {
    ...
    $('input, textarea').bind('input propertychange', function() {
      if(!$(".slick-current [required]").val() == ""){
        $(".slick-arrow.right").removeClass('slick-disabled')
      } else{
        $(".slick-arrow.right").addClass('slick-disabled')
      }
    ...
    $(".form_swiper").on("afterChange", function (event, slick, currentSlide) {
      ...
      // $(".slick-current [required]").each(function (index, el) {
      //   $(".next_slide").prop
      // })
      if(!$(".slick-current [required]").val()){
        $(".slick-arrow.right").addClass('slick-disabled')
      ...
      console.log($(".slick-current [required]").val())
